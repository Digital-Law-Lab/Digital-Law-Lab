...
git remote add origin https://ithub.com:Digital-Law-Lab/docassemble-CLCSA01ServiceDirectory.git
```
:::note
...
- pull into Docassemble Playground and confirm package still runs
...
```shell title='Do this for each branch'
