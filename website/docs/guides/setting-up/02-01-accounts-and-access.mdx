...
* Click on the 'Sign in with Google' button.  This will create a new Docassemble account for you with you gmail address.
  * Do this on both the <Constants.DisplayServiceData data='dev_server' service_name="development" /> and <DisplayServiceData data='prod_server' service_name="production" />) servers.
* Ask <Constants.DisplayAdminData data='github' /> to add you to the Digital Law Lab developers team.

You should be good to go!

### Google Drive
* Send your gmail address to <Constants.DisplayAdminData data='github'/> so you can get access to the <DisplayServiceData data='google_drive' service_name="Digital Law Lab Google Drive" />
