...
* Click on the 'Sign in with Google' button.  This will create a new Docassemble account for you with you gmail address.
  * Do this on both the [development](<DisplayServiceData data='dev_server'/>) and [production](<DisplayServiceData data='prod_server' />) servers.
...
### Slack
* Ask <DisplayAdminData data='github' /> to be invited to the [Digital Law Lab Slack](<DisplayServiceData data='slack' />)