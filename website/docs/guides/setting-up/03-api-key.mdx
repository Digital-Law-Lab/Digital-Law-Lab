...
---
import select_profile_png from '@site/static/docs/03-api-key-select-profile.png';
...
1. From the top-right menu in Docassemble select 'Profile'
 > ![image](/docs/03-api-key-select-profile.png)

  > <img src={select_profile_png} class='image-shadow' />
