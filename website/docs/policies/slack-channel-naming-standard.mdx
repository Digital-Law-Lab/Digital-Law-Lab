...
The idea is to stay as close as possible to the [Repository Naming Standard](/policies/repository-naming-standard)
...
(as per the [Repository Naming Standard](/policies/repository-naming-standard));
...
Follows the appropriate part of the [Repository Naming Standard](/policies/repository-naming-standard)
...
mentioned in the [Repository Naming Standard](/policies/repository-naming-standard).
